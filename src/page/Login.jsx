        ...
        <div>
            ...
            <div className='container mt-5 d-flex justify-content-center w-50'>
                <form className='container py-3 border-orange'>
                    ...
                    <input type="email" name="" id="" placeholder='Email'className='w-100 border-opacity-10 border px-2' required/>
                    <h6 className='pt-3 text-body-secondary'>Mật khẩu<i style={{color:'red'}}>*</i></h6>
                    <input type="password" name="" id="" placeholder='Mật khẩu' className='w-100 border border-opacity-10' required/>
                    <button className='my-3 text-center w-100 py-1 bg-orange border-0 text-light'>ĐĂNG NHẬP</button>
