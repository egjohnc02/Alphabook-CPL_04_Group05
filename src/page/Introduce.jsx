...
function Introduce() {
    ...
    <h1 style={{ marginTop: '50px'}}>Giới thiệu</h1>
     ...
     <p style={{ textAlign: 'center' }}><em >Better Knowledge, Better Success</em></p> 
     <p>Alpha Books được biết đến là một trong những thương hiệu hàng đầu về dòng sách quản trị kinh doanh, phát triển kỹ năng, tài chính, đầu tư… với các cuốn sách hướng dẫn khởi nghiệp, các bài học, phương pháp và kinh nghiệm quản trị của các chuyên gia, và các tập đoàn nổi tiếng trên thế giới. Sau 18 năm hình thành và phát triển, Alpha Books đã từng bước khẳng định tên tuổi của mình, đặc biệt đối với các thế hệ doanh nhân, nhà quản lý và những người trẻ luôn khát khao xây dựng sự nghiệp thành công.</p>

<p>18 năm, từ một công ty nhỏ thành lập bởi một nhóm tri thức trẻ Hà Nội, Alpha Books hiện đã phát triển mở rộng thương hiệu chính là<strong> Alpha Books</strong> - dòng sách quản trị kinh doanh & kỹ năng và với 5 thương hiệu con:<strong> Omega Plus</strong> - dòng sách tinh hoa về văn hóa, lịch sử; <strong> ETS</strong> - dòng sách về khoa học;<strong> Gamma</strong> - dòng sách ngoại ngữ; Sống - dòng sách tác giả Việt; Medinsight - dòng sách y học.</p>

<p>Bên cạnh việc sở hữu hơn <strong>4.000</strong> đầu sách cùng <strong>15.000.000</strong> bản in, Alpha Books còn thành công tiếp cận độc giả với các cuốn sách nổi bật in đậm dấu ấn trong tâm trí người đọc, điển hình như: HBR Onpoint, Quốc gia khởi nghiệp, Trí tuệ Do Thái, Phi lý trí, Tư duy nhanh và chậm, Tiểu sử Steve Jobs, Thiên nga đen, Chiến lược đại dương xanh, Phù thủy sàn chứng khoán,..</p>
<img
          src={ book1}
          alt="Example"
          className="img-fluid"
        ...
        <img
          ...
          style={{ maxwidth: '100%' }}
        />
        <p style={{marginTop:'50px'}}>Alpha Books với sứ mệnh trở thành doanh nghiệp dẫn đầu trong ngành sáng tạo và kinh doanh nội dung, tri thức tại Châu Á đã và đang đi đầu áp dụng công nghệ cao vào vận hành, kinh doanh và sản xuất trong ngành xuất bản dựa trên nền tảng công nghệ. Từ đó, Alpha Books dành hết tâm huyết để đưa những trang tri thức cống hiến vào nền văn hóa đọc. </p>
        <img
          src={ book3}
          alt="Example"
          className="img-fluid"
