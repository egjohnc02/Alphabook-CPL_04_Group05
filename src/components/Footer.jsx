      ...
      <div className="container d-flex py-3">
        <div className="w-25">
          ...
          <div className="mt-3">
            ...
            <p>
              <i>Công ty Cổ phần Sách Alpha</i>
            </p>
            <p>
              <i>MST: 0101602138</i>
            </p>
            <p>
              <i>Ngày cấp: 27/01/2005</i>
            </p>
            <p>
              <i>Nơi cấp: Phòng ĐKKD - Sở Kế Hoạch & Đầu Tư Thành Phố Hà Nội</i>
            </p>
        ...
        <ul className="w-25 py-3">
          ...
          <li>
            <a href="/he-thong-nha-sach" className="nav-link">
              Hệ thống nhà sách
            </a>
          </li>
          <li>
            <a href="/he-thong-phat-hanh" className="nav-link">
              Hệ thống phát hành
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="/hop-tac-kinh-doanh" className="nav-link">
              Hợp tác kinh doanh
            </a>
          </li>
          <li>
        ...
        <ul className="w-25 py-3">
          ...
          <li>
            <a href="/chinh-sach-thanh-toan" className="nav-link">
              Chính sách thanh toán
            </a>
          </li>
          <li>
            <a href="/chinh-sach-van-chuyen" className="nav-link">
              Chính sách vận chuyển
            </a>
          </li>
          <li>
            <a href="/chinh-sach-bao-mat" className="nav-link">
              Chính sách bảo mật
            </a>
          </li>
          <li>
            <a href="/chinh-sach-doi-tra-hoan-tien" className="nav-link">
        ...
        <div className="w-25 py-3">
          ...
          <div className="d-flex gap-3">
            <svg
              ...
              height="30"
              fill="currentColor"
              className="bi bi-geo-alt-fill border border-light p-1 rounded-circle border-2 p-1"
              viewBox="0 0 16 16"
            >
          ...
          <div className="d-flex gap-3">
            <svg
              ...
              height="35"
              fill="currentColor"
              className="bi bi-telephone-fill border border-light p-1 rounded-circle border-2 p-1"
              viewBox="0 0 16 16"
            >
              <path
                fillRule="evenodd"
            ...
            <p>
              <a
                href="tel:0932 329 959"
                className="text-light link-underline link-underline-opacity-0 fs-3 fw-bold"
              >
                0932 329 959
              </a>
            </p>
          ...
          <div className="d-flex gap-3">
            <svg
              ...
              height="35"
              fill="currentColor"
              className="bi bi-envelope-fill border border-light p-1 rounded-circle border-2 p-1"
              viewBox="0 0 16 16"
            >
