      ...
      <div className='d-flex align-items-center justify-content-between py-3 bg-white container'>
        ...
        {isAdmin ? (
          ...
          <div className="d-flex gap-3">
            <Link to='/admin/dashboard' className='text-decoration-none text-dark fw-medium'>
              <nav className='hover-text-orange bg-white'>Dashboard</nav>
            </Link>

            <div className='dropdown position-relative d-inline-block'>
              <Link to='/admin/products' className='text-dark'>
                <button className="dropbtn border-0 bg-white fw-medium hover-text-orange">Quản lý
              ...
              <div className="dropdown-content position-absolute bg-white z-1 p-3">
                <Link to='/admin/products' className='text-decoration-none text-dark d-block'>
                  <p className='hover-text-orange'>Quản lý sản phẩm</p>
                </Link>
                <Link to='/admin/orders' className='text-decoration-none text-dark d-block'>
                  <p className='hover-text-orange'>Quản lý đơn hàng</p>
                </Link>
                <Link to='/admin/users' className='text-decoration-none text-dark d-block'>
                  <p className='hover-text-orange'>Quản lý người dùng</p>
                </Link>
                <Link to='/admin/categories' className='text-decoration-none text-dark d-block'>
                  <p className='hover-text-orange'>Quản lý danh mục</p>
                </Link>
              </div>
            </div>

            <Link to='/admin/news' className='text-decoration-none text-dark fw-medium'>
              <nav className='hover-text-orange bg-white'>Quản lý tin tức</nav>
            </Link>

            <Link to='/admin/events' className='text-decoration-none text-dark fw-medium'>
              <nav className='hover-text-orange bg-white'>Quản lý sự kiện</nav>
            </Link>
          </div>
        ) : (
        ...
        <div className='d-flex'>
          <Link to='/book' className='text-decoration-none text-dark fw-medium'>
