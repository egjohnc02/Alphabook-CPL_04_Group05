                        ...
                        <ListGroup className="cart mt-3">
                            ...
                            {viewportSize == 'lg' && (
                                <>  
                                    ...
                                    <ListGroup.Item>
                                        <div class="item-cart d-flex align-items-center ps-2 pb-3 border-2 border-bottom">
                                            ...
                                            <div className="infor-3-count d-flex bg-prrimary align-items-center">
                                                <button className="btn border p-0"><i class="fa-solid fa-minus p-1"></i></button>
                                                <p className="m-0 px-2 ">3</p>
                                                <button className="btn border p-0"><i class="fa-solid fa-plus p-1"></i></button>
                                            </div>
                            ...
                            {viewportSize == 'md' && (
                                <>
                                    ...
                                    <ListGroup.Item>
                                        <div class="item-cart d-flex ps-2 pb-3 border-2 border-bottom">
                                            <div className="info-1 d-flex">
                                                <img src={thumbnailItemCart} alt="item-img-cart" className="me-2"></img>
